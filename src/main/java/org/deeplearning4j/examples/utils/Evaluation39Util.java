...
/**
 */
public class Evaluation39Util implements Serializable {
    ...
    protected static Logger log = LoggerFactory.getLogger(Evaluation39Util.class);
    ...
    // Empty constructor
    public Evaluation39Util() {}

    // Constructor that takes number of output classes
    public Evaluation39Util(int numClasses) {
        for(int i = 0; i < numClasses; i++)
            labelsList.add(i);
        confusion = new ConfusionMatrix<>(labelsList);
    }

    public Evaluation39Util(List<String> labels) {
    ...
    public Evaluation39Util(Map<Integer, String> labels) {
     ...
     */
    public void merge(Evaluation39Util other){
