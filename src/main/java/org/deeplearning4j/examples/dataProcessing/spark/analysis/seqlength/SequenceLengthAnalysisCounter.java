package org.deeplearning4j.examples.dataProcessing.spark.analysis.seqlength;
...
public class SequenceLengthAnalysisCounter implements Serializable {
    ...
    public SequenceLengthAnalysisCounter add(SequenceLengthAnalysisCounter other){
