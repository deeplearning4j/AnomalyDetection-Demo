 ...
 */
@NoArgsConstructor
public class CollectAtUIDriverFunctionModified implements Function2<JavaRDD<Tuple3<Long, INDArray, List<Writable>>>,Time,Void> {

    @Override
    public Void call(JavaRDD<Tuple3<Long, INDArray, List<Writable>>> v1, Time time) throws Exception {
        UIDriverModified uiDriver = UIDriverModified.getInstance();
